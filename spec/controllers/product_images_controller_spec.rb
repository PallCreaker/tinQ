...
RSpec.describe ProductImagesController, :type => :controller do
  ...
  # ProductImagesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET index" do
    it "assigns all product_images as @product_images" do
      ...
      expect(assigns(:product_images)).to eq([product_image])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested product_image as @product_image" do
      product_image = ProductImage.create! valid_attributes
      get :show, {:id => product_image.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested product_image as @product_image" do
      product_image = ProductImage.create! valid_attributes
      get :edit, {:id => product_image.to_param}, valid_session
      expect(assigns(:product_image)).to eq(product_image)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new ProductImage" do
        expect {
          post :create, {:product_image => valid_attributes}, valid_session
      ...
      it "redirects to the created product_image" do
        post :create, {:product_image => valid_attributes}, valid_session
        expect(response).to redirect_to(ProductImage.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved product_image as @product_image" do
        post :create, {:product_image => invalid_attributes}, valid_session
        expect(assigns(:product_image)).to be_a_new(ProductImage)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested product_image" do
        product_image = ProductImage.create! valid_attributes
        put :update, {:id => product_image.to_param, :product_image => new_attributes}, valid_session
      ...
      it "assigns the requested product_image as @product_image" do
        product_image = ProductImage.create! valid_attributes
        put :update, {:id => product_image.to_param, :product_image => valid_attributes}, valid_session
        expect(assigns(:product_image)).to eq(product_image)
      end
      ...
      it "redirects to the product_image" do
        product_image = ProductImage.create! valid_attributes
        put :update, {:id => product_image.to_param, :product_image => valid_attributes}, valid_session
        expect(response).to redirect_to(product_image)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the product_image as @product_image" do
        product_image = ProductImage.create! valid_attributes
        put :update, {:id => product_image.to_param, :product_image => invalid_attributes}, valid_session
        expect(assigns(:product_image)).to eq(product_image)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested product_image" do
      product_image = ProductImage.create! valid_attributes
      expect {
        delete :destroy, {:id => product_image.to_param}, valid_session
      }.to change(ProductImage, :count).by(-1)
    end
    ...
    it "redirects to the product_images list" do
      product_image = ProductImage.create! valid_attributes
      delete :destroy, {:id => product_image.to_param}, valid_session
      expect(response).to redirect_to(product_images_url)
    end
  end
